...
function PinupCapture() {
    ...
    /*!
     *  Capture the [Tab] using this here library
     *
     *  tab (Tab object)
     *  callback (optional function( string imageDataURL ))
     */
    this.combMetaInfo = function( tab, callback ) {
        chrome.tabs.sendMessage( tab.id, {action: 'grabData'}, function( data ){
     ...
     *  callback (optional function( string imageDataURL ))
     */
    this.captureTab = function( tab, callback ) {
    ...
    /*!
     *  Cleanup process; restores browser to state before this library made a load of mess
     *  
     *  tab (Tab object)
     */
    this.cleanUp = function( tab ) {
