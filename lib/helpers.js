...
var Http = {
    post: function( location, data, callback ) {
        if ( typeof location !== 'string' || typeof data !== 'string' ) callback( null, true );
        var http    = new XMLHttpRequest();
        http.onload = function( res ) {
            var out = JSON.parse( res.currentTarget.response );
            if ( typeof callback === 'function' ) callback( out, false )
        };
